...
var app = new Vue({
  ...
  data: {
    ...
    navSocials: ['<i class="fab fa-twitter"></i>', '<i class="fab fa-instagram"></i>', '<i class="fab fa-behance"></i>', '<i class="fas fa-volleyball-ball"></i>', '<i class="fab fa-google-plus-square"></i>', '<i class="fab fa-git"></i>', '<i class="fab fa-linkedin-in"></i>', '<i class="fab fa-pinterest"></i>'],
